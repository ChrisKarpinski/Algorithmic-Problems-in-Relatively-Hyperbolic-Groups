...
\begin{document}
	...
	% add in a picture here d(x,e_{-}) + d(e_{-}, f_{-}) + d(f_{-}, y), d(x,e_{+}) + d(e_{+}, f_{-}) + d(f_{-}, y), d(x,e_{-}) + d(e_{-}, f_{+}) + d(f_{+}, y), d(x,e_{+}) + d(e_{+}, f_{+}) + d(f_{+}, y)
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.6\linewidth]{"../Desktop/Honours Project/IMG_1528"}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.5\linewidth]{"../Desktop/Honours Project/IMG_1549"}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.7\linewidth]{"../Desktop/Honours Project/IMG_1550"}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.5\linewidth]{"../Desktop/Honours Project/IMG_1533"}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.7\linewidth]{"../Desktop/Honours Project/IMG_1543"}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.7\linewidth]{"../Desktop/Honours Project/IMG_1544"}
...
\end{figure}
	...
	\begin{proof}
		...
		%$d(p_1, a_1^j (p_0)) = d(p_1, p_0) + j \ell \geq d(p_1, p_0) > d(p_1, p_2) + 2 \delta$ and $d(a_1^j (p_0), a_1^n (p_1)) = d(p_1, a_1^n(p_1)) - d(p_1, a_1^j (p_0)) = n \ell - (d(p_1, p_0) + j \ell) = n \ell - (d(p_1, p_2) + 2 \delta + 1 + j \ell) \geq n\ell - (2K+1)^{6 \delta} \ell - d(p_1, p_2) - 2 \delta - 1 > (2K + 1)^{6 (\delta+1)} + d(p_1, p_2) + d(a_1^n(p_1), a_2^n (p_2)) + 4 \delta - (2K+1)^{6 \delta} \ell - d(p_1, p_2) - 2 \delta  - 1 > d(a_1^n (p_1), a_2^n (p_2)) + 2 \delta$, as required.
		...
		%if $y \in [p_1, p_0]$, we have $d(y,x) \geq d(p_0, x) \geq 6 \delta > 4 \delta$, if $y \in [p_1, p_2]$, then by the triangle inequality, $d(y,x) \geq d(p_1, x) - d(p_1, y) \geq d(p_1, x) - d(p_1, p_2) = d(p_0, p_1) + d(p_0, x) - d(p_1, p_2) > d(p_1, p_2) + 2 \delta + 6 \delta - d(p_1, p_2) = 8 \delta$, and if $y \in [p_0, q_0]$, then by the triangle inequality, $d(y,x) \geq d(p_0, x) - d(y, p_0) \geq d(p_0, x) - d(p_0, q_0) > 6 \delta - 2 \delta = 4 \delta$. 
		...
		%$d(y, \sigma_2) \leq d(y, a_2^{m(s-t)}(q(a_1^{m(t-s)}(y)))) = d(a_2^{m(t-s)}(y), q(a_1^{m(t-s)})(y)) = d(a_1^{m(t-s)}(y), q(a_1^{m(t-s)})(y)) \leq 2 \delta$. 
...
\end{figure}
	...
	\begin{proof}
		...
		%$d(x, p_1) \leq d(x, q) \leq d(x, xc_1^{-1}) + d(xc_1^{-1}, q) \leq \vert c_1 \vert + (1 + \vert a_1 \vert)K \leq N_1 (\vert a_1 \vert + \vert b_1 \vert) + M_1 + (1 + \vert a_1 \vert)K$. 
		...
		%$d(a_1^{tn}(p_1), a_2^{-1}a_1 a_2 (p_2)) \leq d(1, a_1^{tn}(p_1)) + d(1, a_2^{-1}a_1 a_2 (p_2)) \leq (R + K) (\vert a_1 \vert + 1) + (R+K) (\vert a_1 \vert + 2 \vert a_2 \vert + 1) \leq 2(R+K)(\vert a_1 \vert + \vert a_2 \vert + 1) \leq 2(R+K)(\vert a_1 \vert + \vert a_2 \vert + \vert b_1 \vert + \vert b_2 \vert)$. 
		...
		%$d(a_1^{tn}(p_1), a_2^{-1} a_1^{tn} a_2 (p_2)) \leq d(a_1^{tn}(p_1), a_2^{-1} a_1^{tm} a_2 (p_2)) + \vert n - m \vert \ell \leq 2(R + K) (\vert a_1 \vert + \vert a_2 \vert + 1) + 8(N_1 + N_2 + 2K + R)\mu + M_1 + M_2 \leq 8 (N_1 + N_2 + 6K + 5R) \mu + M_1 + M_2$. 
		...
		%$\vert n \vert \leq (2K + 1)^{6 \delta} + 1/\ell (d(p_1, p_2) + d(a_1^{tn}(p_1), a_2^{-1} a_1^{tn}a_2(p_2)) + 4 \delta) \leq (2K + 1)^{6 \delta} + 1/\ell (2(N_1 + N_2 + K) (\vert a_1 \vert + \vert a_2 \vert + \vert b_1 \vert + \vert b_2 \vert) + M_1 + M_2 + 8 (N_1 + N_2 + 6K + 5R) \mu + M_1 + M_2 + 4 \delta) \leq (2K + 1)^{6 \delta} + 1/\ell (8(2N_1 + 2N_2 + 6K + 5R)\mu + 2(M_1 + M_2) + 4 \delta)$. 
